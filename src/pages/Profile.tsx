...
export function ProfilePage() {
  ...
  const hasPointAccess = !isPremium && pointBalance >= 5;
  const membershipLabel = isPremium ? 'Premium' : `${pointBalance.toLocaleString()} Points`;
