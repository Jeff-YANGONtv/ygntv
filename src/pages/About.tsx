...
export function AboutPage() {
  ...
  return <div className="page about-page">
    ...
    <section className="container about-tagline" aria-labelledby="tagline-title"><span className="eyebrow">WHAT IS TO BE DONE ?</span><h2 id="tagline-title">More than <em>just streaming.</em></h2><p>နိုင်ငံတကာ ရုပ်ရှင်နှင့် ရုပ်သံဇာတ်လမ်းတွဲများကို မြန်မာဘာသာစာတန်းထိုးဖြင့် ကြည့်ရှုနိုင်သော သာမန် ဒစ်ဂျစ်တယ် ရုပ်သံပလက်ဖောင်းမှသည် ပြည်တွင်းအွန်လိုင်းအသုံးပြုသူများ၏နေ့စဉ်ဘဝအတွင်း ထဲထဲဝင်ဝင်စိမ့်ဝင်နိုင်သည်အထိ ဆက်လက်ကြိုးစားသွားမည်ဖြစ်သည်။</p></section>
    ...
    <section className="about-contact" aria-label="Contact Yangon TV"><div className="about-contact__marquee"><div className="about-contact__track"><span>လုပ်ငန်းပါတနာအဖြစ်ချိတ်ဆက်လို၍ဖြစ်စေ ၊ စီးပွားရေးမိတ်ဖက်အဖြစ်ပူးပေါင်းလို၍ဖြစ်စေ ဆက်သွယ်လိုသည့်အခါတွင်း၎င်း သက်ဆိုင်ရာအာဏာပိုင်အဖွဲ့အစည်းများမှ တစုံတရာ စစ်ဆေးစုံစမ်းမေးမြန်းလိုသည်များရှိပါက အောက်ဖော်ပြပါဆိုရှယ်မီဒီယာနှင့်မေးလ်လိပ်စာများထံ တိုက်ရိုက်ဆက်သွယ်မေးမြန်းနိုင်ပါသည်။</span><span aria-hidden="true">လုပ်ငန်းပါတနာအဖြစ်ချိတ်ဆက်လို၍ဖြစ်စေ ၊ စီးပွားရေးမိတ်ဖက်အဖြစ်ပူးပေါင်းလို၍ဖြစ်စေ ဆက်သွယ်လိုသည့်အခါတွင်း၎င်း သက်ဆိုင်ရာအာဏာပိုင်အဖွဲ့အစည်းများမှ တစုံတရာ စစ်ဆေးစုံစမ်းမေးမြန်းလိုသည်များရှိပါက အောက်ဖော်ပြပါဆိုရှယ်မီဒီယာနှင့်မေးလ်လိပ်စာများထံ တိုက်ရိုက်ဆက်သွယ်မေးမြန်းနိုင်ပါသည်။</span></div></div><div className="container about-contact__inner"><div className="about-contact__heading"><span className="eyebrow"><i aria-hidden="true" />CONTACT LINKS</span><small className="about-contact__reply">REPLY WITHIN 1–12 HRS</small></div><div className="about-contact__links"><a href="mailto:office@ygntv.org" aria-label="Email Yangon TV" className="about-contact__link"><span className="about-contact__icon about-contact__icon--mail"><Mail size={23} aria-hidden="true" /></span></a><a href="https://t.me/officeygntvbot" target="_blank" rel="noreferrer" aria-label="Open Yangon TV Telegram" className="about-contact__link"><span className="about-contact__icon about-contact__icon--telegram"><Send size={23} aria-hidden="true" /></span></a><a href="https://messenger.com/yangontvfbpage" target="_blank" rel="noreferrer" aria-label="Open Yangon TV Messenger" className="about-contact__link"><span className="about-contact__icon about-contact__icon--messenger"><MessageCircle size={23} aria-hidden="true" /></span></a></div></div></section>
