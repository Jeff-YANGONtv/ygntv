...
export function AboutPage() {
  ...
  return <div className="page about-page">
    ...
    <section className="about-contact" aria-labelledby="contact-title"><div className="container about-contact__inner"><div className="about-contact__heading"><span className="eyebrow"><i aria-hidden="true" />CONTACT US</span><h2 id="contact-title">Let’s connect.</h2></div><div className="about-contact__links"><a href="mailto:office@ygntv.org" className="about-contact__link"><span className="about-contact__icon about-contact__icon--mail"><Mail size={21} aria-hidden="true" /></span><span><b>MAIL</b><small>office@ygntv.org</small></span></a><a href="https://t.me/officeygntvbot" target="_blank" rel="noreferrer" className="about-contact__link"><span className="about-contact__icon about-contact__icon--telegram"><Send size={21} aria-hidden="true" /></span><span><b>TELEGRAM</b><small>officeygntvbot</small></span></a><a href="https://messenger.com/yangontvfbpage" target="_blank" rel="noreferrer" className="about-contact__link"><span className="about-contact__icon about-contact__icon--messenger"><MessageCircle size={21} aria-hidden="true" /></span><span><b>MESSENGER</b><small>yangontvfbpage</small></span></a></div></div></section>
