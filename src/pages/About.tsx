import { ArrowRight, BookOpen, Check, FileText, LockKeyhole, Mail, MessageCircle, MonitorPlay, Send, Smartphone, Tv } from 'lucide-react';
...
export function AboutPage() {
  ...
  return <div className="page about-page">
    ...
    <section className="container about-policies" aria-labelledby="policy-links-title"><div className="about-section-heading"><span className="eyebrow">POLICY &amp; TRUST</span><h2 id="policy-links-title">Clear rules for<br /><em>better viewing.</em></h2><p>Yangon TV ၏ လက်ရှိ feature များအပေါ် အခြေခံထားသော Privacy Policy နှင့် Terms of Service ကို ဒီမှာ ဖတ်ရှုနိုင်ပါတယ်။</p></div><div className="about-policies__grid"><Link className="about-policy-card" to="/privacy-policy"><span className="about-policy-card__icon"><LockKeyhole size={21} /></span><span><small>READ THE POLICY</small><strong>Privacy Policy</strong><em>သင့် data ကို ဘယ်လိုကိုင်တွယ်သလဲ</em></span><ArrowRight size={18} /></Link><Link className="about-policy-card about-policy-card--terms" to="/terms-of-service"><span className="about-policy-card__icon"><FileText size={21} /></span><span><small>READ THE TERMS</small><strong>Terms of Service</strong><em>Yangon TV ကို အသုံးပြုရန် စည်းမျဉ်းများ</em></span><ArrowRight size={18} /></Link></div></section>
