...
export function AboutPage() {
  return <div className="page page-about"><section className="container about-hero"><div><h1>About Yangon TV</h1></div></section><section className="container about-content"><div className="about-lede"><span className="eyebrow">Our point of view</span><p>Yangon TV is an independent entertainment platform built around the films, series, recaps, and conversations that bring Myanmar audiences closer to the screen.</p></div><div className="about-columns"><div><h2>Curated, not crowded.</h2><p>There is more content than ever. We believe the answer is not more noise — it is better context. Every title on Yangon TV is a small invitation to slow down and find something that feels like yours.</p></div><div><h2>Made for the moment.</h2><p>Our platform is designed to feel easy, warm, and familiar. Whether you are here for a single episode or a late-night rabbit hole, there is always a place to begin.</p></div></div></section><section className="container about-quote"><blockquote>“The stories we return to are the ones that know how to stay.”</blockquote><span>— Yangon TV editorial note</span></section></div>;
}
