...
import { Bell, CheckCheck, Clapperboard, Crown, Film, History, Home, LogOut, Menu, Newspaper, Send, UserRound, X } from 'lucide-react';
...
const navigation: Array<{ label: string; to: string; icon: typeof Home }> = [];
